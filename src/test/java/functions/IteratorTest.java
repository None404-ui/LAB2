...
public class IteratorTest {
    ...
    @Test
    public void testLinkedListTabulatedFunction_IteratorWithForEach() {
        double[] xValues = {1.0, 2.0, 3.0};
        double[] yValues = {1.0, 4.0, 9.0};
    ...
    @Test
    public void testLinkedListTabulatedFunction_IteratorWithWhile() {
        double[] xValues = {1.0, 2.0, 3.0};
        double[] yValues = {1.0, 4.0, 9.0};
        LinkedListTabulatedFunction function = new LinkedListTabulatedFunction(xValues, yValues);
    ...
    @Test
    public void testLinkedListTabulatedFunction_IteratorNoSuchElementException() {
        double[] xValues = {1.0, 2.0};
        double[] yValues = {1.0, 4.0};
        LinkedListTabulatedFunction function = new LinkedListTabulatedFunction(xValues, yValues);
